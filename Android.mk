...
LOCAL_MODULE_TAGS   := optional
LOCAL_MODULE_CLASS  := EXECUTABLES
LOCAL_SHARED_LIBRARIES :=  libbase libhidlbase libutils libfmq libbinder liblog vendor.qti.hardware.qccsyshal@1.2-halimpl vendor.qti.hardware.qccsyshal@1.2 vendor.qti.hardware.qccsyshal@1.1 vendor.qti.hardware.qccsyshal@1.0 libc++ libc libm libdl
...
LOCAL_MODULE        := libmsp
LOCAL_MODULE_CLASS  := SHARED_LIBRARIES
LOCAL_SHARED_LIBRARIES :=  libz libjsoncpp libxml2 liblog libutils libhidlbase vendor.qti.hardware.embmssl@1.0 vendor.qti.hardware.embmssl@1.1 libbinder_ndk vendor.qti.hardware.embmsslaidl-V1-ndk libc++ libc libm libdl
LOCAL_MODULE_SUFFIX := .so
LOCAL_STRIP_MODULE  := false
LOCAL_MULTILIB      := 64
LOCAL_MODULE_OWNER  := qcom
...
LOCAL_MODULE_CLASS  := SHARED_LIBRARIES
LOCAL_SHARED_LIBRARIES :=  libcurl libssl libcrypto libcutils liblog libutils libbase libfmq libhidlbase libbinder libbinder_ndk vendor.qti.hardware.qccvndhal@1.0 vendor.qti.hardware.qccsyshal@1.2 android.hardware.common-V2-ndk vendor.qti.qccvndhal_aidl-V1-ndk libc++ libc libm libdl
LOCAL_MODULE_SUFFIX := .so
LOCAL_STRIP_MODULE  := false
LOCAL_MULTILIB      := 64
LOCAL_MODULE_OWNER  := qcom
...
LOCAL_MODULE_CLASS  := SHARED_LIBRARIES
LOCAL_SHARED_LIBRARIES :=  libcurl libssl libcrypto libcutils liblog libutils libbase libfmq libhidlbase libbinder_ndk vendor.qti.hardware.qccvndhal@1.0 vendor.qti.hardware.qccsyshal@1.2 android.hardware.common-V2-ndk vendor.qti.qccvndhal_aidl-V1-ndk libc++ libc libm libdl
LOCAL_MODULE_SUFFIX := .so
LOCAL_STRIP_MODULE  := false
LOCAL_MULTILIB      := 64
LOCAL_MODULE_OWNER  := qcom
...
LOCAL_MODULE_CLASS  := SHARED_LIBRARIES
LOCAL_SHARED_LIBRARIES :=  libhidlbase libutils vendor.qti.qesdhal@1.0 vendor.qti.qesdhal@1.1 vendor.qti.qesdhal@1.2 vendor.qti.qesdhalaidl-V2-ndk libbinder_ndk liblog libcutils libcrypto libjsoncpp libnativehelper libc++ libc libm libdl
LOCAL_MODULE_SUFFIX := .so
LOCAL_STRIP_MODULE  := false
LOCAL_MULTILIB      := 64
LOCAL_MODULE_OWNER  := qcom
...
LOCAL_MODULE_CLASS  := SHARED_LIBRARIES
LOCAL_SHARED_LIBRARIES :=  libnativehelper libcutils liblog libutils libbase libtflite libbinder_ndk vendor.qti.hardware.qspa-V1-ndk libc++ libc libm libdl
LOCAL_MODULE_SUFFIX := .so
LOCAL_STRIP_MODULE  := false
LOCAL_MULTILIB      := 64
LOCAL_MODULE_OWNER  := qcom
...
include $(CLEAR_VARS)
LOCAL_MODULE        := vendor.qti.hardware.embmsslaidl-V1-ndk
LOCAL_MODULE_CLASS  := SHARED_LIBRARIES
LOCAL_SHARED_LIBRARIES :=  libbinder_ndk libc++ libc libm libdl
LOCAL_MODULE_SUFFIX := .so
LOCAL_STRIP_MODULE  := false
...
LOCAL_MODULE_OWNER  := qcom
LOCAL_MODULE_TAGS   := optional
LOCAL_SRC_FILES     := ../../.././target/product/qssi/system_ext/lib64/vendor.qti.hardware.embmsslaidl-V1-ndk.so
LOCAL_MODULE_PATH   := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_SYSTEM_EXT)/lib64
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_OWNER  := qcom
LOCAL_MODULE_TAGS   := optional
LOCAL_SRC_FILES     := ../../.././target/product/qssi/system_ext/lib/vendor.qti.qesdhal@1.2.so
LOCAL_MODULE_PATH   := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_SYSTEM_EXT)/lib
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_OWNER  := qcom
LOCAL_MODULE_TAGS   := optional
LOCAL_SRC_FILES     := ../../.././target/product/qssi/system_ext/lib/vendor.qti.qesdhalaidl-V2-ndk.so
LOCAL_MODULE_PATH   := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_SYSTEM_EXT)/lib
include $(BUILD_PREBUILT)
